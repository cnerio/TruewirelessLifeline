...
// error_reporting(E_ALL);   
    ...
    public function read(){
		...
		//if($_POST){
			...
			//print_r($data);
			$camposBase=array("customer_id","first_name","second_name","phone_number","email","dob","city","state","zipcode","order_id","order_status","duplicated","program_benefit","created_at");
			$addWhere="";
			$count=0;
